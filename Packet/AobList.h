...
std::wstring AOB_SendPacket[] = {
	...
	#else
	// v131.0
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC ?? 53 56 8B F1 8D 9E ?? ?? ?? ?? 8B CB 89 5D ?? E8 ?? ?? ?? ?? 8B 46 ?? 33 C9 3B C1 89 4D ?? 0F 84",
	// v164.0 to v186.1
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC ?? 53 56 8B F1 8D 9E ?? ?? ?? ?? 57 8B CB 89 5D ?? E8 ?? ?? ?? ?? 8B 46 ?? 33 FF 3B C7",
	// v188.0 to v302.0
	...
	// KMS v2.160
	L"6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC ?? 56 57 A1 ?? ?? ?? ?? 33 C4 50 8D 44 24 ?? 64 A3 00 00 00 00 8B F9 8D 44 24 ?? 50 8D 8F ?? ?? ?? ?? 51 8D 4C 24 ?? E8 ?? ?? ?? ?? 8B 47 08 C7 44 24 ?? 00 00 00 00 85 C0 0F 84",
	// BMS v24.0
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 56 57 8B F9 8D 77 ?? 8B CE 89 75 ?? E8 ?? ?? ?? ?? 8B 47 08 33 C9 3B C1 89 4D ?? 74",
	// TWMS v122.1
	L"6A 04 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F9 8D 77 ?? 8B CE 89 75 ?? E8 ?? ?? ?? ?? 8B 47 08 33 C9 89 4D ?? 3B C1 74",
	// EMS v55.1
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 14 53 56 8B F1 8D 9E ?? ?? ?? ?? 57 8B CB 89 5D ?? E8 ?? ?? ?? ?? 8B 46 08 33 FF 3B C7 89 7D ?? 0F 84",
	// KMS v2.1
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 1C 53 56 8B F1 8B 46 18 33 DB 3B C3 0F 84 ?? ?? ?? ?? 83 F8 FF 0F 84 ?? ?? ?? ?? 39 5E 24 0F 85",
	// KMS v1.68
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 83 EC 58 57 8B F9 8B 47 08 85 C0 0F 84 ?? ?? ?? ?? 83 F8 FF 0F 84 ?? ?? ?? ?? 83 7F 14 00 0F 85",
	#endif
};
...
std::wstring AOB_ProcessPacket[] = {
	...
	// TWMS v122.1
	L"6A 08 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F9 68 ?? ?? ?? ?? 8D 4D EC E8 ?? ?? ?? ?? 8B 75 08 83 65 FC 00 8B CE E8 ?? ?? ?? ?? 0F B7 C0",
	// EMS v70.1
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 51 A1 ?? ?? ?? ?? 53 56 8B D9 57 8D 4D ?? 89 45 ?? E8 ?? ?? ?? ?? 8B 7D 08 83 65 FC 00 8B CF E8 ?? ?? ?? ?? 33 F6 66 8B F0 8B C6 83 E8 ?? 0F 84",
	// CMS v85.1
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 51 A1 ?? ?? ?? ?? 53 56 8B D9 57 8D 4D EC 89 45 F0 E8 ?? ?? ?? ?? 8B 7D 08 83 65 FC 00 8B CF E8 ?? ?? ?? ?? 33 F6 66 8B F0 83 FE ?? 7F ?? 74 ?? 8B",
	#endif
};


#ifndef _WIN64
std::wstring AOB_ProcessPacket_KMS55[] = {
	// KMS v2.55, header 1 byte
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 51 A1 ?? ?? ?? ?? 56 57 8B F9 8D 4D EC 89 45 F0 E8 ?? ?? ?? ?? 8B 75 08 83 65 FC 00 8B CE E8 ?? ?? ?? ?? 0F B6",
};
#endif
...
std::wstring AOB_COutPacket[] = {
	...
	#else
	// v164.0 to v186.1
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 51 56 8B F1 83 66 04 00 8D 45 ?? 50 8D 4E 04 68 00 01 00 00 89 75 ?? E8 ?? ?? ?? ?? FF 75 08 83 65 ?? 00 8B CE E8",
	// v188.0
	...
	// v308.0
	L"6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 51 56 A1 ?? ?? ?? ?? 33 C4 50 8D 44 24 ?? 64 A3 00 00 00 00 8B F1 89 74 24 ?? 8D 44 24 1C 50 8D 4E ?? 68 ?? ?? ?? ?? C7 01 00 00 00 00 E8",
	// CMS v99.1
	...
	// TWMS v122.1
	L"6A 04 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F1 89 75 ?? 8D 45 ?? 50 8D 4E 04 83 21 00 68 00 01 00 00 E8 ?? ?? ?? ?? FF 75 08 83 65 FC 00 8B CE E8",
	#endif
};

#ifndef _WIN64
std::wstring AOB_COutPacket_2[] = {
	// v131.0
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 51 56 8B F1 83 66 04 00 8D 45 ?? 50 8D 4E 04 68 00 01 00 00 89 75 ?? E8 ?? ?? ?? ?? FF 75 0C 83 65 ?? 00 FF 75 08 8B CE E8",
};

std::wstring AOB_COutPacket_3[] = {
	// GMS v62.1
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 51 56 8B F1 83 66 04 00 8D 45 ?? 50 8D 4E 04 68 00 01 00 00 89 75 ?? E8 ?? ?? ?? ?? FF 75 10 83 65 ?? 00 FF 75 0C 8B CE FF 75 08 E8",
};
#endif
...
std::wstring AOB_Encode1[] = {
	...
	// TWMS v122.1
	L"56 6A 01 8B F1 E8 ?? ?? ?? ?? 8B 4E 08 8B 46 04 8A 54 24 08 88 14 08 FF 46 08 5E C2 04 00",
	#endif
};
...
std::wstring AOB_Encode2[] = {
	...
	// TWMS v122.1
	L"56 6A 02 8B F1 E8 ?? ?? ?? ?? 8B 4E 08 8B 46 04 66 8B 54 24 08 66 89 14 08 83 46 08 02 5E C2 04 00",
	#endif
};
...
std::wstring AOB_Encode4[] = {
	...
	// TWMS v122.1
	L"56 6A 04 8B F1 E8 ?? ?? ?? ?? 8B 4E 08 8B 46 04 8B 54 24 08 89 14 08 83 46 08 04 5E C2 04 00",
	#endif
};
...
std::wstring AOB_EncodeStr[] = {
	...
	// TWMS v122.1
	L"6A 04 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F1 8B 45 08 83 65 FC 00 85 C0 74 05 8B 40 FC EB 02 33 C0 83 C0 02 50 8B CE",
	#endif
};
...
std::wstring AOB_EncodeBuffer[] = {
	...
	// TWMS v122.1
	L"56 FF 74 24 0C 8B F1 E8 ?? ?? ?? ?? 8B 46 04 8B 4E 08 03 C8 51 FF 74 24 10 FF 74 24 10 E8 ?? ?? ?? ?? 01 46 08 83 C4 0C 5E C2 08 00",
	#endif
};
...
std::wstring AOB_Decode1[] = {
	...
	// TWMS v122.1
	L"6A 14 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F1 89 75 E8 0F B7 56 0C 8B 46 14 8B 4E 08 83 65 FC 00 2B D0 52 03 C1 50 8D 45 EF 50 E8 ?? ?? ?? ?? 83 C4 0C 01 46 14 8A 45 EF E8 ?? ?? ?? ?? C3",
	// GMS v126.1
	L"55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC ?? 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D 45 ?? 64 A3 00 00 00 00 89 65 ?? 89 4D ?? 8B 51 18 8B 41 0C 8B 71 08 2B C2 C7 45 ?? 00 00 00 00 83 F8 01 73 ?? 68",
	// CMS v88.1
	L"51 0F B7 41 0C 8B 51 14 56 8B 71 08 2B C2 03 F2 83 F8 01 73 17 68 ?? ?? ?? ?? 8D 4C 24 08 51 C7 44 24 0C 26 00 00 00 E8 ?? ?? ?? ?? 8A 06 42 89 51 14 5E 59 C3",
	#endif
};
...
std::wstring AOB_Decode2[] = {
	...
	// BMS v24.0
	L"55 8B EC 51 8B 51 14 8B 41 08 56 0F B7 71 0C 2B F2 03 C2 83 FE 02 5E 73 ?? 68",
	// TWMS v122.1
	L"6A 14 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F1 89 75 E8 0F B7 56 0C 8B 46 14 8B 4E 08 83 65 FC 00 2B D0 52 03 C1 50 8D 45 EC 50 E8 ?? ?? ?? ?? 83 C4 0C 01 46 14 66 8B 45 EC E8 ?? ?? ?? ?? C3",
	// GMS v126.1
	L"55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC ?? 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D 45 ?? 64 A3 00 00 00 00 89 65 ?? 89 4D ?? 8B 51 18 8B 41 0C 8B 71 08 2B C2 C7 45 ?? 00 00 00 00 83 F8 02 73 ?? 68",
	// CMS v88.1
	L"51 8B 51 14 8B 41 08 56 0F B7 71 0C 2B F2 03 C2 83 FE 02 5E 73 17 68 ?? ?? ?? ?? 8D 44 24 04 50 C7 44 24 08 26 00 00 00 E8 ?? ?? ?? ?? 0F B7 00 83 C2 02 89 51 14 59 C3",
	#endif
};
...
std::wstring AOB_Decode4[] = {
	...
	// BMS v24.0
	L"55 8B EC 51 8B 51 14 8B 41 08 56 0F B7 71 0C 2B F2 03 C2 83 FE 04 5E 73 ?? 68",
	// TWMS v122.1
	L"6A 14 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F1 89 75 E8 0F B7 56 0C 8B 46 14 8B 4E 08 83 65 FC 00 2B D0 52 03 C1 50 8D 45 EC 50 E8 ?? ?? ?? ?? 83 C4 0C 01 46 14 8B 45 EC E8 ?? ?? ?? ?? C3",
	// GMS v126.1
	L"55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC ?? 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D 45 ?? 64 A3 00 00 00 00 89 65 ?? 89 4D ?? 8B 51 18 8B 41 0C 8B 71 08 2B C2 C7 45 ?? 00 00 00 00 83 F8 04 73 ?? 68",
	// CMS v88.1
	L"51 8B 51 14 8B 41 08 56 0F B7 71 0C 2B F2 03 C2 83 FE 04 5E 73 17 68 ?? ?? ?? ?? 8D 44 24 04 50 C7 44 24 08 26 00 00 00 E8 ?? ?? ?? ?? 8B 00 83 C2 04 89 51 14 59 C3",
	#endif
};
...
std::wstring AOB_DecodeStr[] = {
	...
	// BMS v24.0
	L"B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 51 51 83 65 ?? 00 83 65 ?? 00 56 57 8B F1 8B 46 14 0F B7 4E 0C 6A 01",
	// TWMS v122.1
	L"6A 14 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F1 89 75 E8 83 65 EC 00 8B 7D 08 83 27 00 33 C0 40 89 45 FC 0F B7 56 0C 8B 4E 08 89 45 EC 8B 46 14 2B D0 52 03 C1 50 57 E8 ?? ?? ?? ?? 83 C4 0C 01 46 14 8B C7 E8 ?? ?? ?? ?? C2 04 00",
	// GMS v126.1
	L"55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC ?? 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D 45 ?? 64 A3 00 00 00 00 89 65 ?? 8B F1 89 75 ?? C7 45 ?? 00 00 00 00 8B 7D 08 B8 01 00 00 00 89 45 ?? C7 07 00 00 00 00 8B 56 0C 8B 4E 08 89 45 ?? 8B 46 18 2B D0 52 03 C1 50 57 E8 ?? ?? ?? ?? 83 C4 0C 01 46 18",
	// CMS v88.1
	L"6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 51 56 57 A1 ?? ?? ?? ?? 33 C4 50 8D 44 24 10 64 A3 00 00 00 00 8B F1 33 C0 89 44 24 0C 8B 7C 24 20 89 07 0F B7 56 0C 8B 4E 08 89 44 24 18 8B 46 14 2B D0 52 03 C1 50 57 C7 44 24 18 01 00 00 00 E8 ?? ?? ?? ?? 83 C4 0C 01 46 14 8B C7 8B 4C 24 10 64 89 0D 00 00 00 00 59 5F 5E 83 C4 10 C2 04",
	#endif
};
...
std::wstring AOB_DecodeBuffer[] = {
	...
	// BMS v24.0
	L"55 8B EC 56 8B F1 0F B7 56 0C 8B 4E 14 8B 46 08 57 8B 7D 0C 2B D1 03 C1 3B D7 73 ?? 68",
	// TWMS v122.1
	L"6A 10 B8 ?? ?? ?? ?? E8 ?? ?? ?? ?? 8B F1 89 75 EC 0F B7 56 0C 8B 46 14 8B 4E 08 83 65 FC 00 2B D0 52 03 C1 50 FF 75 0C FF 75 08 E8 ?? ?? ?? ?? 83 C4 10 01 46 14 E8 ?? ?? ?? ?? C2 08 00",
	// GMS v126.1
	L"55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC ?? 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D 45 ?? 64 A3 00 00 00 00 89 65 ?? 8B F1 89 75 ?? 8B 4E 18 8B 46 0C 8B 56 08 8B 7D 0C 2B C1 03 CA C7 45 ?? 00 00 00 00 3B C7 73 ?? 68",
	#endif
};
